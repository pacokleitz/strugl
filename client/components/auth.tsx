        ...
        <div className="shadow-lg rounded-md bg-gray-100 w-auto m-auto justify-center space-y-8 flex flex-col p-10">
            <div className="w-full space-y-3 flex flex-col m-auto font-semibold ">
                <div className="flex flex-col">
                    ...
                    <input type="text" className="rounded-md px-2 py-1 font-semibold focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-opacity-50"></input>
                </div>
                <div className="flex flex-col">
                    <label className="text-gray-600">Email</label>
                    <input type="email" className="rounded-md px-2 py-1 font-semibold focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-opacity-50"></input>
                </div>
                <div className="flex flex-col">
                    <label className="text-gray-600">Password</label>
                    <input type="password" className="rounded-md px-2 py-1 font-semibold focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-opacity-50"></input>
                </div>
                <div className="flex flex-col">
